  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="projetZymaApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="projetZymaApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="libelleLabel" for="tag-libelle">
                  <Translate contentKey="projetZymaApp.tag.libelle">Libelle</Translate>
                </Label>
                <AvField
                  id="tag-libelle"
                  data-cy="libelle"
