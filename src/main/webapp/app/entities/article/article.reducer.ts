...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_ARTICLE: 'article/PARTIAL_UPDATE_ARTICLE',
...
export default (state: ArticleState = initialState, action): ArticleState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ARTICLE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ARTICLE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ARTICLE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IArticle> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_ARTICLE,
